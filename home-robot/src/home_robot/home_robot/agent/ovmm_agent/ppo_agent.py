...
class PPOAgent(Agent):
    ...
    def __init__(
        ...
        self.actor_critic = policy.from_config_ori_re(
            self.rl_config,
            skill_obs_spaces,
    ...
    def act(
        ...
        self.local_map = F.interpolate(semantic_map.local_map[:,[3,6,7]], scale_factor=0.5, mode='bilinear', align_corners=True)
