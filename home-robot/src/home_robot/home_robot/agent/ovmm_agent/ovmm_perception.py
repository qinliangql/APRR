...
from home_robot.perception.detection.yolow_sam.detect import YolowSAMPerception
...
class OvmmPerception:
    ...
    def __init__(
        ...
        if self._detection_module == "yolow_sam2":
            self._segmentation = YolowSAMPerception(
                vocabulary="custom",
                custom_vocabulary=".",
            ...
            pass 
        # elif self._detection_module == "detic":
    ...
    def _process_obs(self, obs: Observations):
        ...
        """
        # print("self._current_vocabulary.num_sem_categories:",self._current_vocabulary.num_sem_categories)
        # print("self._current_vocabulary.num_sem_obj_categories:",self._current_vocabulary.num_sem_obj_categories)
        # print("self.vocabulary_name_to_id[obs.task_observations['object_name']]:",self.vocabulary_name_to_id[obs.task_observations['object_name']])
        # print("self.vocabulary_name_to_id[obs.task_observations['place_recep_name']]:",self.vocabulary_name_to_id[obs.task_observations['place_recep_name']])
        # print("self.vocabulary_name_to_id[obs.task_observations['start_recep_name']]:",self.vocabulary_name_to_id[obs.task_observations['start_recep_name']])
