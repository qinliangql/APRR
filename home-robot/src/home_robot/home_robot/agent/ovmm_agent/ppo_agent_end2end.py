...
class PPOAgent(Agent):
    ...
    def act(
        ...
        skill_obs_keys_tmp = ["joint", "ovmm_nav_goal_segmentation","object_embedding", "receptacle_segmentation", "robot_start_compass", "robot_start_gps", "robot_head_depth", "start_receptacle"]
