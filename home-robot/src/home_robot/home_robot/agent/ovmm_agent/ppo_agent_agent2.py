...
class PPOAgent(Agent):
    ...
    def __init__(
        ...
        self.actor_critic = policy.from_config3(
            self.rl_config,
            skill_obs_spaces,
        ...
        model_path = '/aiarena/gpfs/code/code/OVMM/home-robot_ini/home-robot/data/new_checkpoints/ovmm/nav_to_obj_pointnav_mapgoal/keep/latest_keep.pth'
        if model_path:
    ...
    def act(
        self, observations: Observations, info, semantic_map,dis_target
    ) -> Tuple[
        Union[
            ContinuousFullBodyAction,
            ContinuousNavigationAction,
