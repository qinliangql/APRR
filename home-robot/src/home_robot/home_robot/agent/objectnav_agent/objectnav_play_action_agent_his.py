...
class ObjectNavAgent(Agent):
    ...
    def __init__(
        ...
        # 创建或连接到数据库
        self.conn = sqlite3.connect('/aiarena/gpfs/code/code/OVMM/home-robot/mytest/train_db/train.db')
    ...
    def act(self, obs: Observations) -> Tuple[DiscreteNavigationAction, Dict[str, Any]]:
        ...
        # relative_stg = [path[-1][1] - path[0][1], path[-1][0] - path[0][0]] # test wrong target
