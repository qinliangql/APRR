...
class DiscretePlanner:
    ...
    def __init__(
        ...
        print("self.turn_angle:",self.turn_angle)
    ...
    def plan(
        ...
        # print("start_x, start_y, start_o:",start_x, start_y, start_o)
        ...
        for relative_stg_point in relative_stg:
            goal_map = goal_map*0.0
            set_goal = [
                int((start_y + relative_stg_point[1])*100.0/self.map_resolution - gx1),
                int((start_x + relative_stg_point[0])*100.0/self.map_resolution - gy1),
            ]
            goal_gloabl_pos = [start_x + relative_stg_point[0],start_y + relative_stg_point[1]]
            print("goal_gloabl_pos:",goal_gloabl_pos)
            ...
            # cv2.imshow("goal_map:",goal_map*255)
            # cv2.waitKey(1)
        ...
        # print("short_term_goal:",short_term_goal)
    ...
    def _get_short_term_goal(
        ...
        if not astar_flag:
            ...
            if plan_to_dilated_goal:
                ...
                # print("closest_goal_pt:",closest_goal_pt)
