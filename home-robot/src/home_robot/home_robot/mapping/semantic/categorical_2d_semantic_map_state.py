...
class Categorical2DSemanticMapState:
    ...
    def __init__(
        ...
        self.global_map_size = self.global_map_size_cm // self.resolution   # 960
        self.local_map_size = self.local_map_size_cm // self.resolution     # 480
        ...
        num_channels = self.num_sem_categories + MC.NON_SEM_CHANNELS    # 5+5
