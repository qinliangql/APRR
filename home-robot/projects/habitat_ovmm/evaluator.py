...
class OVMMEvaluator(PPOTrainer):
    ...
    def collect_info(self, observations, episode, step):
        save_dir = "/aiarena/gpfs/code/code/OVMM/home-robot/datadump/collect_rep_obj_a13_large/"
    ...
    def local_evaluate(
        ...
        while count_episodes < num_episodes:
            ...
            # if current_episode.scene_id in scene_id_list:
            #     continue
            # else:
            #     scene_id_list.append(current_episode.scene_id)
            ...
            # if '104348328_171513363_1' != current_episode_key:
            # if '102816756_3' != current_episode_key:
            #     count_episodes += 1
            #     pbar.update(1)
            #     continue 
            ...
            step = 0
            while not done:
                action, info, _ , collect_over_flag = agent.act(observations)
                
                # print("current_episode.candidate_objects_hard:",current_episode.candidate_objects_hard)
                # print("current_episode.candidate_start_receps:",current_episode.candidate_start_receps)
