...
class OVMMEvaluator(PPOTrainer):
    ...
    def collect_info(self, observations, episode, step):
        save_dir = "/aiarena/gpfs/code/code/OVMM/home-robot/datadump/collect_rep_obj_a12_large/"
    ...
    def local_evaluate(
        ...
        while count_episodes < num_episodes:
            ...
            # if '107733960_175999701_42' != current_episode_key:
            # if '106878915_174887025_1' != current_episode_key:
            # if '104348328_171513363_35' != current_episode_key:
            #     count_episodes += 1
            #     pbar.update(1)
            #     continue 
            ...
            while not done:
                ...
                step = step + 1
                if step > 800:  # 我的实验设置的是800步，这里改为1200测全阶段的
                    done = True
