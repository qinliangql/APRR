...
python projects/habitat_ovmm/eval_baselines_agent.py \
    --env_config projects/habitat_ovmm/configs/env/hssd_demo_all.yaml \
    --evaluation_type local \
    --agent_type play_rl_all_stage \
    --baseline_config_path projects/habitat_ovmm/configs/agent/heuristic_agent_rl.yaml\
    habitat.dataset.split=val habitat.dataset.episode_indices_range=[150,200] 
...
# ln -s /aiarena/group/eaigroup/ql/ovmm/run_data /aiarena/gpfs/code/code/OVMM/home-robot/datadump
